  ...
  host.innerHTML = `
    <footer><div class="wrap">
      ...
      <p class="legal">Прототип нового сайта. Марки серий, диапазоны и индексы
        ...
        ним оборудование нельзя</b>. Цены появятся из 1С ERP через
        административную панель — здесь их пока нет ни одной. Гарантия
        зависит от позиции (по закону минимум на каждый товар, у части
        оборудования 3 или 5 лет) — точные сроки по маркам заводом ещё не
        переданы. Сроков изготовления и номеров сертификатов здесь тоже нет:
        завод их пока не передал, а выдумывать мы не стали.</p>
    </div></footer>`;
}
